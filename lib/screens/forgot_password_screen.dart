...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  void sendOtp() async {
    ...
    try {
      bool success = await ApiService.forgotPassword(
        email: emailController.text.trim(),
      );

      if (success) {
        if (mounted) {
          AppToasts.success(context, "OTP sent to your email!");
          Navigator.push(
            context,
            MaterialPageRoute(
                            ...
                            child: Column(
                              children: [
                                TextFormField(
                                  ...
                                  decoration: _modernInputStyle(context, "Email Address", icon: Icons.email_outlined),
